"""
MegaSource Scraper - VegaMovies
================================
Scrapes VegaMovies for Movies and TV Series.
...
TITLE = "VegaMovies"
VERSION = "1.0.1"
DESCRIPTION = "VegaMovies Scraper for Movies and TV Series"

DEFAULT_MAIN_URL = "https://vegamovies.mq"
...
def update_dynamic_urls():
    ...
    if status == 200 and body:
        try:
            ...
            if data.get("vegamovies"):
                MAIN_URL = data["vegamovies"].rstrip("/")
            if data.get("vcloud"):
...
def get_streams(media_type, media_id, config=None):
    ...
    if media_type == "movie":
        ...
        # Match Season & Episode containers
